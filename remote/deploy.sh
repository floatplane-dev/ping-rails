...
case master
  ...
  and echo curl https://api.ping.floatplane.dev/sanity-check -H "Content-Type: application/vnd.api+json"
  and curl https://api.ping.floatplane.dev/sanity-check -H "Content-Type: application/vnd.api+json"
